...
business impact, and urgency. These concepts do not appear in raw 
scanner output. They are derived by evaluating input fields against 
...
\begin{figure}[h]
\centering
\missingfigure{Decision tree for business impact. Root: cvss\_score? 
None: UNKNOWN. Less than 4.0: LOW. 4.0-6.9: asset\_criticality? 
High: MEDIUM. Medium: LOW. Low: LOW. 7.0-8.9: asset\_criticality? 
High: HIGH. Medium: MEDIUM. Low: MEDIUM. 9.0 or above: 
asset\_criticality? High: CRITICAL. Medium: HIGH. Low: HIGH.}
...
= True} $\to$ \textbf{High}. For business impact: 
\texttt{cvss\_score = 9.8} $\geq 9.0$ $\to$ 
\texttt{asset\_criticality = High} $\to$ \textbf{Critical}. 
